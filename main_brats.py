from UGATIT_brats import UGATIT
import argparse
from utils import *
...
def parse_args():
    ...
    parser.add_argument('--save_freq', type=int, default=1, help='The number of model save freq')
    ...
    parser.add_argument('--img_size', type=int, default=240, help='The size of image')
