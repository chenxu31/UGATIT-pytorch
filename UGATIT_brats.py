...
class UGATIT(object) :
    ...
    def build_model(self):
        ...
        self.dataloader_s = torch.utils.data.DataLoader(dataset_s, batch_size=self.batch_size, shuffle=True,
